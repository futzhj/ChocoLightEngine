...
| fa29d75 (Phase 3) | 25942469141 | ⏳ in_progress | (回填) |
| 66ee607 (Phase 4) | 25942649835 | ⏳ queued | (回填) |
...
| CI | ⏳ Phase 1 ✅ / Phase 2 ✅ / Phase 3 ⏳ / Phase 4 ⏳ (待回填) |

**Phase F.0.10.2 真物理 Split-Screen 交付完成 (待 CI 全 6/6 success 回填本文档).**
